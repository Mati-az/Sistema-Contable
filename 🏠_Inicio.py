...
st.write("Visualiza el total de activos, pasivos, ingresos y gastos junto con su variación porcentual respecto al total hasta mes anterior.")
st.write("")
...
with col2:
    ...
    st.metric(label="ACTIVOS", value=total_activo, delta=f"{var_activo:.2f}%", help = None)
...
with col4:
    ...
    st.metric(label="PASIVOS", value=total_pasivo, delta=f"{var_pasivo:.2f}%", help = None)
...
with col6:
    ...
    st.metric(label="INGRESOS", value=total_ingresos, delta=f"{var_ingresos:.2f}%",help=None)
...
with col8:
    ...
    st.metric(label="GASTOS", value=total_gastos, delta=f"{var_gastos:.2f}%", help = None)
